...
var (
	...
	ErrMissingJWKSURI            = errors.New("missing jwks_uri in metadata response") // 502 Bad Gateway
	...
	ErrUnexpectedStatusCode      = errors.New("unexpected status code from metadata endpoint") // 502 Bad Gateway
)
