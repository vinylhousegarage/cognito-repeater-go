...
func newTestDeps(doFunc func(*http.Request) (*http.Response, error)) deps.HandlerDependencies {
	return deps.HandlerDependencies{
		Config:     testhelpers.MockCfg,
		HTTPClient: &testhelpers.MockHTTPClient{DoFunc: doFunc},
	}
}
...
func TestWhoamiHandler_Success(t *testing.T) {
	...
	deps := newTestDeps(func(req *http.Request) (*http.Response, error) {
...
func TestWhoamiHandler_MetadataFetchError(t *testing.T) {
	...
	deps := newTestDeps(func(*http.Request) (*http.Response, error) {
